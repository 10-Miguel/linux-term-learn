print("10)""Calcular el nivel promedio de un equipo de jugadores: Escribe un algoritmo que solicite el \nnivel de tres jugadores y calcule el nivel promedio del equipo.")
print("Solución") #aquí el processsssso
...
d=a+b+c
e=d/3
print(f"La habilidad en promedio de este equipo es de {e:.1f} niveles")