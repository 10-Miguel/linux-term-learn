print("11) Calcular el daño crítico en un ataque: Escribe un algoritmo que solicite el daño base de un ataque y el multiplicador crítico, y calcule el daño crítico.")
print("Solución") #Empezamos el proceso aquí
